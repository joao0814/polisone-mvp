...
export const researchScenarios = [
  {
    ...
    year: "2026",
    status: "Concluída",
    searchTerms: ["região metropolitana", "saúde", "campinas centro"],
    summaryCards: [
    ...
    cityDistribution: [
      ...
      { label: "Sumaré", value: "21,8%", color: "#1687df" },
      { label: "Hortolândia", value: "18,5%", color: "#ff9518" },
      { label: "Monte Mor", value: "13,5%", color: "#ff3030" },
    ],
    voteInfluence: [
      { label: "Propostas", value: "41,6%", color: "#00b765" },
      { label: "Honestidade", value: "24,4%", color: "#1687df" },
      { label: "Presença local", value: "19,1%", color: "#ff9518" },
    ...
    priorityRanking: [
      { position: "1", label: "Saúde", value: 92, votes: "4.520 votos" },
      { position: "2", label: "Segurança", value: 74, votes: "1.100 votos" },
      { position: "3", label: "Educação", value: 62, votes: "927 votos" },
      { position: "4", label: "Emprego/renda", value: 48, votes: "754 votos" },
      { position: "5", label: "Outros", value: 34, votes: "698 votos" },
    ],
    electorateProfile: {
    ...
    spontaneousVotes: [
      ...
      { name: "Letícia Aguiar", party: "Progressistas", votes: "27.272", percent: "6,85%", score: 76, avatar: "LA" },
    ...
    growingCandidates: [
      { position: "1", name: "Carlos Eduardo", votes: "3.200 votos", growth: "32%", avatar: "CE" },
      { position: "2", name: "Janaína Salmeirão", votes: "2.700 votos", growth: "28%", avatar: "JS" },
      { position: "3", name: "Jorge Paz", votes: "1.500 votos", growth: "22%", avatar: "JP" },
      { position: "4", name: "Roberto Silva", votes: "1.200 votos", growth: "16%", avatar: "RS" },
      { position: "5", name: "Maria Eduarda", votes: "750 votos", growth: "9%", avatar: "ME" },
    ],
    footerMetrics: [
      ...
      { title: "Ranking do candidato", value: "3", note: "Subiu duas posições em relação à semana anterior" },
    ],
    perceptionPanels: [
      {
      ...
      },
      {
        ...
        items: [
          ...
          { label: "Provável votar", value: 28 },
          { label: "Ainda estou indeciso", value: 25 },
          { label: "Não votaria", value: 14 },
        ],
      },
      {
        title: "Como está a imagem do candidato hoje?",
        items: [
  ...
  },
  {
    ...
    year: "2025",
    status: "Em campo",
    searchTerms: ["vale do paraíba", "pesquisa espontânea", "são josé"],
    summaryCards: [
    ...
    cityDistribution: [
      { label: "São José dos Campos", value: "52,1%", color: "#00b765" },
      { label: "Jacareí", value: "19,7%", color: "#1687df" },
      { label: "Taubaté", value: "16,4%", color: "#ff9518" },
      { label: "Caçapava", value: "11,8%", color: "#ff3030" },
    ],
    voteInfluence: [
      { label: "Honestidade", value: "35,2%", color: "#00b765" },
      { label: "Propostas", value: "28,9%", color: "#1687df" },
      { label: "Histórico político", value: "21,6%", color: "#ff9518" },
    ...
    cityProblems: [
      ...
      { label: "Habitação", value: 8 },
      { label: "Outros", value: 6 },
    ],
    priorityRanking: [
      { position: "1", label: "Saúde", value: 86, votes: "3.910 votos" },
      { position: "2", label: "Emprego/renda", value: 69, votes: "1.540 votos" },
      { position: "3", label: "Segurança", value: 58, votes: "1.118 votos" },
      { position: "4", label: "Educação", value: 44, votes: "884 votos" },
      { position: "5", label: "Mobilidade", value: 29, votes: "603 votos" },
    ],
    electorateProfile: {
    ...
    growingCandidates: [
      { position: "1", name: "Roberta Lima", votes: "2.900 votos", growth: "26%", avatar: "RL" },
      { position: "2", name: "Dr. Elton", votes: "2.540 votos", growth: "22%", avatar: "DE" },
      { position: "3", name: "Felipe Gomes", votes: "1.860 votos", growth: "18%", avatar: "FG" },
      { position: "4", name: "Maria Eduarda", votes: "1.200 votos", growth: "13%", avatar: "ME" },
      { position: "5", name: "Paulo Reis", votes: "980 votos", growth: "10%", avatar: "PR" },
    ],
    footerMetrics: [
      { title: "Meta da semana", value: "1.500", note: "TOTAL" },
      { title: "Realizadas na semana", value: "902", note: "60,1% DO TOTAL" },
      { title: "Crescimento de Pesquisas", value: "18%", note: "Em relação à semana anterior", trend: true },
      { title: "Crescimento de Municípios pesquisados", value: "12%", note: "Em relação à semana anterior", trend: true },
      { title: "Ranking do candidato", value: "4", note: "Manteve a posição na semana" },
    ],
    perceptionPanels: [
      {
        title: "Você conhece o candidato?",
        items: [
          { label: "Sim", value: 31 },
          { label: "Já ouvi falar", value: 29 },
          { label: "Conheço de vista", value: 24 },
          { label: "Não conheço", value: 16 },
        ],
      },
      {
        title: "Hoje, qual a chance de votar nesse candidato?",
  ...
  },
  {
    ...
    voteInfluence: [
      ...
      { label: "Histórico político", value: "26,1%", color: "#1687df" },
    ...
    priorityRanking: [
      { position: "1", label: "Transporte", value: 88, votes: "5.240 votos" },
      { position: "2", label: "Saúde", value: 72, votes: "2.004 votos" },
      { position: "3", label: "Segurança", value: 56, votes: "1.480 votos" },
      { position: "4", label: "Moradia", value: 41, votes: "1.022 votos" },
      { position: "5", label: "Emprego/renda", value: 33, votes: "910 votos" },
    ],
    electorateProfile: {
    ...
    spontaneousVotes: [
      { name: "Letícia Aguiar", party: "Progressistas", votes: "43.210", percent: "10,11%", score: 100, avatar: "LA" },
      ...
      { name: "Carlos Eduardo", party: "União", votes: "28.116", percent: "6,58%", score: 65, avatar: "CE" },
      { name: "Marta Souza", party: "PSD", votes: "20.408", percent: "4,78%", score: 47, avatar: "MS" },
    ],
    growingCandidates: [
      { position: "1", name: "Marta Souza", votes: "4.100 votos", growth: "29%", avatar: "MS" },
      { position: "2", name: "Carlos Eduardo", votes: "3.480 votos", growth: "24%", avatar: "CE" },
      { position: "3", name: "Letícia Aguiar", votes: "2.960 votos", growth: "18%", avatar: "LA" },
      { position: "4", name: "Dulce Rita", votes: "1.840 votos", growth: "13%", avatar: "DR" },
      { position: "5", name: "Paula Nunes", votes: "1.200 votos", growth: "9%", avatar: "PN" },
    ],
    footerMetrics: [
      { title: "Meta da semana", value: "2.800", note: "TOTAL" },
      { title: "Realizadas na semana", value: "2.132", note: "76,1% DO TOTAL" },
      { title: "Crescimento de Pesquisas", value: "22%", note: "Em relação à semana anterior", trend: true },
      { title: "Crescimento de Municípios pesquisados", value: "11%", note: "Em relação à semana anterior", trend: true },
      { title: "Ranking do candidato", value: "2", note: "Subiu uma posição em relação à semana anterior" },
    ],
    perceptionPanels: [
      {
        title: "Você conhece o candidato?",
        items: [
          { label: "Sim", value: 42 },
          { label: "Já ouvi falar", value: 30 },
          { label: "Conheço de vista", value: 18 },
          { label: "Não conheço", value: 10 },
        ],
      },
      {
        title: "Hoje, qual a chance de votar nesse candidato?",
