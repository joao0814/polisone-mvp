...
export const createCommunication = (payload) => apiRequest('/admin/communications', { method: 'POST', body: payload instanceof FormData ? payload : JSON.stringify(payload) })
export const updateCommunication = (id, payload) => apiRequest(`/admin/communications/${id}`, { method: 'PATCH', body: payload instanceof FormData ? payload : JSON.stringify(payload) })
